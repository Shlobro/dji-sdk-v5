...
public class BytesUtil {
    ...
    public static int getLongCurIndex;
    ...
    public static byte getByte(byte[] byArray, int n, int n2) {
        return 0;
    }
    ...
    private static String getString(byte[] byArray, String string) {
        return null;
    }

    private static String getString(byte[] byArray, int n, int n2, String string) {
        return null;
    }
    ...
    public static String byteObjects2Hex(Object[] objectArray) {
        return null;
    }
    ...
    public static int kmp(byte[] byArray, byte[] byArray2, int n, int n2, int[] nArray) {
        return 0;
    }

    public static int[] kmpNext(byte[] byArray) {
        return null;
    }

    public static int setBitValue(int n, @IntRange(from=0L, to=31L) int n2, byte by) {
        return 0;
    }
