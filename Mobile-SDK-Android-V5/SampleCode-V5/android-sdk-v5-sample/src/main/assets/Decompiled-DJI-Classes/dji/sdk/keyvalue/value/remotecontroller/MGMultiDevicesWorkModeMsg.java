...
public class MGMultiDevicesWorkModeMsg
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    ...
    public MGMultiDevicesWorkModeMsg() {
    }

    public MGMultiDevicesWorkModeMsg(MGMultiDevicesWorkModeType mGMultiDevicesWorkModeType, Integer n) {
    }

    public static MGMultiDevicesWorkModeMsg fromJson(String string) {
        return null;
    }
