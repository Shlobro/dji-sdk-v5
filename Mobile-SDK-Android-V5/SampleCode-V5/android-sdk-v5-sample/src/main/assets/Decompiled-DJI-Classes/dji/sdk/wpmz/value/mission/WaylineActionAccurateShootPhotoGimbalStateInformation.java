...
public class WaylineActionAccurateShootPhotoGimbalStateInformation
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    Double pitch = 0.0;
    ...
    public WaylineActionAccurateShootPhotoGimbalStateInformation() {
    }

    public WaylineActionAccurateShootPhotoGimbalStateInformation(Double pitch, Double roll, Double yaw) {
        if (pitch != null) {
            this.pitch = pitch;
        }
        if (roll != null) {
    ...
    public static WaylineActionAccurateShootPhotoGimbalStateInformation fromJson(String jsonString) {
        WaylineActionAccurateShootPhotoGimbalStateInformation tmpValueResult_ = new WaylineActionAccurateShootPhotoGimbalStateInformation();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WaylineActionAccurateShootPhotoGimbalStateInformation)) {
            return false;
        }
        WaylineActionAccurateShootPhotoGimbalStateInformation that = (WaylineActionAccurateShootPhotoGimbalStateInformation)o;
