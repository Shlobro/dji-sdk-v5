...
public class DJIHmsKey {
    protected static final List<DJIKeyInfo<?>> keyList = new ArrayList();
    private static final ComponentType componentType = ComponentType.HMS;
    private static final SubComponentType subComponentType = SubComponentType.IGNORE;
    public static final DJIKeyInfo<HMSAircraftMaintainInfo> KeyHMSGetAircraftBasicMaintainData = new DJIKeyInfo(componentType.value(), subComponentType.value(), "HMSGetAircraftBasicMaintainData", new DJIValueConverter<HMSAircraftMaintainInfo>(HMSAircraftMaintainInfo.class)).canGet(true).canSet(false).canListen(false).canPerformAction(false).setIsEvent(false);
    public static final DJIKeyInfo<HMSAircraftMaintainInfo> KeyHMSGetAircraftRoutineMaintainData = new DJIKeyInfo(componentType.value(), subComponentType.value(), "HMSGetAircraftRoutineMaintainData", new DJIValueConverter<HMSAircraftMaintainInfo>(HMSAircraftMaintainInfo.class)).canGet(true).canSet(false).canListen(false).canPerformAction(false).setIsEvent(false);
    public static final DJIKeyInfo<HMSAircraftMaintainInfo> KeyHMSGetAircraftDeepMaintainData = new DJIKeyInfo(componentType.value(), subComponentType.value(), "HMSGetAircraftDeepMaintainData", new DJIValueConverter<HMSAircraftMaintainInfo>(HMSAircraftMaintainInfo.class)).canGet(true).canSet(false).canListen(false).canPerformAction(false).setIsEvent(false);
    public static final DJIKeyInfo<HMSCameraLensMaintainInfo> KeyHMSGetCameraLensMaintainData = new DJIKeyInfo(componentType.value(), subComponentType.value(), "HMSGetCameraLensMaintainData", new DJIValueConverter<HMSCameraLensMaintainInfo>(HMSCameraLensMaintainInfo.class)).canGet(true).canSet(false).canListen(false).canPerformAction(false).setIsEvent(false);
    public static final DJIKeyInfo<HMSMaintainInfo> KeyHMSSetMaintainData = new DJIKeyInfo(componentType.value(), subComponentType.value(), "HMSSetMaintainData", new DJIValueConverter<HMSMaintainInfo>(HMSMaintainInfo.class)).canGet(false).canSet(true).canListen(false).canPerformAction(false).setIsEvent(false);
    public static final DJIActionKeyInfo<HMSMaintainType, EmptyMsg> KeyHMSResetMaintainData = new DJIActionKeyInfo<HMSMaintainType, EmptyMsg>(componentType.value(), subComponentType.value(), "HMSResetMaintainData", new SingleValueConverter<HMSMaintainType, HMSMaintainParam>(HMSMaintainType.class, HMSMaintainParam.class), EmptyValueConverter.converter).canGet(false).canSet(false).canListen(false).canPerformAction(true).setIsEvent(false);
    public static final DJIKeyInfo<MGHMSDiagnosticMsg> KeyMGHMSDiagnostic = new DJIKeyInfo(componentType.value(), subComponentType.value(), "MGHMSDiagnostic", new DJIValueConverter<MGHMSDiagnosticMsg>(MGHMSDiagnosticMsg.class)).canGet(false).canSet(false).canListen(true).canPerformAction(false).setIsEvent(false);
    public static final DJIKeyInfo<MGHMSComponentType> KeyMGHMSSubscribe = new DJIKeyInfo<MGHMSComponentType>(componentType.value(), subComponentType.value(), "MGHMSSubscribe", new SingleValueConverter<MGHMSComponentType, MGHMSSubscribeComponentMsg>(MGHMSComponentType.class, MGHMSSubscribeComponentMsg.class)).canGet(false).canSet(true).canListen(false).canPerformAction(false).setIsEvent(false);
    public static final DJIKeyInfo<MGHMSComponentType> KeyMGHMSUnsubscribe = new DJIKeyInfo<MGHMSComponentType>(componentType.value(), subComponentType.value(), "MGHMSUnsubscribe", new SingleValueConverter<MGHMSComponentType, MGHMSSubscribeComponentMsg>(MGHMSComponentType.class, MGHMSSubscribeComponentMsg.class)).canGet(false).canSet(true).canListen(false).canPerformAction(false).setIsEvent(false);
    public static final DJIKeyInfo<List<ChargerModuleMsg>> KeyChargerMaintain = new DJIKeyInfo<List>(componentType.value(), subComponentType.value(), "ChargerMaintain", new SingleValueConverter<List, ChargerModuleInfo>(List.class, ChargerModuleInfo.class)).canGet(true).canSet(false).canListen(true).canPerformAction(false).setIsEvent(false);
    public static final DJIActionKeyInfo<List<ChargerModuleMsg>, EmptyMsg> KeyClearChargerMaintain = new DJIActionKeyInfo<List, EmptyMsg>(componentType.value(), subComponentType.value(), "ClearChargerMaintain", new SingleValueConverter<List, ChargerModuleInfo>(List.class, ChargerModuleInfo.class), EmptyValueConverter.converter).canGet(false).canSet(false).canListen(false).canPerformAction(true).setIsEvent(false);
    public static final DJIActionKeyInfo<EmptyMsg, EmptyMsg> KeyHMSHeartbeat = new DJIActionKeyInfo<EmptyMsg, EmptyMsg>(componentType.value(), subComponentType.value(), "HMSHeartbeat", EmptyValueConverter.converter, EmptyValueConverter.converter).canGet(false).canSet(false).canListen(false).canPerformAction(true).setIsEvent(false);
    ...
    static {
        keyList.add(KeyHMSGetAircraftBasicMaintainData);
        keyList.add(KeyHMSGetAircraftRoutineMaintainData);
        keyList.add(KeyHMSGetAircraftDeepMaintainData);
        keyList.add(KeyHMSGetCameraLensMaintainData);
        keyList.add(KeyHMSSetMaintainData);
        keyList.add(KeyHMSResetMaintainData);
        keyList.add(KeyMGHMSDiagnostic);
        keyList.add(KeyMGHMSSubscribe);
        keyList.add(KeyMGHMSUnsubscribe);
        keyList.add(KeyChargerMaintain);
        keyList.add(KeyClearChargerMaintain);
        keyList.add(KeyHMSHeartbeat);
