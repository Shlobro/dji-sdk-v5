...
public class DJIWiFiKey {
    ...
    private static final ComponentType componentType = ComponentType.WIFI;
    private static final SubComponentType subComponentType = SubComponentType.IGNORE;
    public static final DJIKeyInfo<Boolean> KeyIsSDROffWhenWifiFast = new DJIKeyInfo(componentType.value(), subComponentType.value(), "IsSDROffWhenWifiFast", SingleValueConverter.BooleanConverter).canGet(false).canSet(false).canListen(true).canPerformAction(false).setIsEvent(false);
    ...
    static {
        keyList.add(KeyIsSDROffWhenWifiFast);
