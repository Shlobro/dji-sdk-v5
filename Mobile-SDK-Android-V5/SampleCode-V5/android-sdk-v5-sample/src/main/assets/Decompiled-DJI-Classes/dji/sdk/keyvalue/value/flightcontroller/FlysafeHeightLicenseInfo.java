...
public class FlysafeHeightLicenseInfo
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    ...
    public FlysafeHeightLicenseInfo() {
    }

    public FlysafeHeightLicenseInfo(FlysafeLicenseBaseInfo flysafeLicenseBaseInfo, Integer n) {
    }

    public static FlysafeHeightLicenseInfo fromJson(String string) {
        return null;
    }
