...
public class DJISpotLightKey {
    ...
    public static final DJIKeyInfo<Boolean> KeyIsSpotLightOpened = new DJIKeyInfo(componentType.value(), subComponentType.value(), "IsSpotLightOpened", SingleValueConverter.BooleanConverter).canGet(true).canSet(true).canListen(true).canPerformAction(false).setIsEvent(false);
    public static final DJIKeyInfo<Double> KeyTemperature = new DJIKeyInfo(componentType.value(), subComponentType.value(), "Temperature", SingleValueConverter.DoubleConverter).canGet(true).canSet(false).canListen(true).canPerformAction(false).setIsEvent(false);
    public static final DJIKeyInfo<Integer> KeyBrightness = new DJIKeyInfo(componentType.value(), subComponentType.value(), "Brightness", SingleValueConverter.IntegerConverter).canGet(true).canSet(true).canListen(true).canPerformAction(false).setIsEvent(false);
    public static final DJIKeyInfo<IntMinMax> KeyBrightnessRange = new DJIKeyInfo(componentType.value(), subComponentType.value(), "BrightnessRange", new DJIValueConverter<IntMinMax>(IntMinMax.class)).canGet(true).canSet(false).canListen(true).canPerformAction(false).setIsEvent(false);
    ...
    static {
        keyList.add(KeyIsSpotLightOpened);
        keyList.add(KeyTemperature);
        keyList.add(KeyBrightness);
        keyList.add(KeyBrightnessRange);
