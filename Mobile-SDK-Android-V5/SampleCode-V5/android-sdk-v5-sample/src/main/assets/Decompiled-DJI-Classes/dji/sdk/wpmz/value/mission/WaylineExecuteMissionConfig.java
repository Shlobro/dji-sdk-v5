...
public class WaylineExecuteMissionConfig
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    ...
    public static WaylineExecuteMissionConfig fromJson(String jsonString) {
        WaylineExecuteMissionConfig tmpValueResult_ = new WaylineExecuteMissionConfig();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WaylineExecuteMissionConfig)) {
            return false;
        }
        WaylineExecuteMissionConfig that = (WaylineExecuteMissionConfig)o;
        return Objects.equals(this.flyToWaylineMode, that.flyToWaylineMode) && Objects.equals(this.finishAction, that.finishAction) && Objects.equals(this.exitOnRCLostBehavior, that.exitOnRCLostBehavior) && Objects.equals(this.exitOnRCLostType, that.exitOnRCLostType) && Objects.equals(this.globalTransitionalSpeed, that.globalTransitionalSpeed) && Objects.equals(this.securityTakeOffHeight, that.securityTakeOffHeight) && Objects.equals(this.isSecurityTakeOffHeightSet, that.isSecurityTakeOffHeightSet) && Objects.equals(this.droneInfo, that.droneInfo) && Objects.equals(this.payloadInfo, that.payloadInfo) && Objects.equals(this.globalRTHHeight, that.globalRTHHeight) && Objects.equals(this.isGlobalRTHHeightSet, that.isGlobalRTHHeightSet) && Objects.equals(this.avoidInfo, that.avoidInfo) && Objects.equals(this.isAvoidInfoSet, that.isAvoidInfoSet) && Objects.equals(this.isAvoidLimitAreaSet, that.isAvoidLimitAreaSet) && Objects.equals(this.precisionType, that.precisionType) && Objects.equals(this.isPrecisionSet, that.isPrecisionSet);
    }

    public int hashCode() {
        return Objects.hash(this.flyToWaylineMode, this.finishAction, this.exitOnRCLostBehavior, this.exitOnRCLostType, this.globalTransitionalSpeed, this.securityTakeOffHeight, this.isSecurityTakeOffHeightSet, this.droneInfo, this.payloadInfo, this.globalRTHHeight, this.isGlobalRTHHeightSet, this.avoidInfo, this.isAvoidInfoSet, this.isAvoidLimitAreaSet, this.precisionType, this.isPrecisionSet);
    }
}
