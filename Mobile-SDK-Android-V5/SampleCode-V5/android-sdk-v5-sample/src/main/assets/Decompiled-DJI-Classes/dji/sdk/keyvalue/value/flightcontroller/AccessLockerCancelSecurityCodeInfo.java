...
public class AccessLockerCancelSecurityCodeInfo
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    String username;
    ...
    public AccessLockerCancelSecurityCodeInfo() {
    }

    public AccessLockerCancelSecurityCodeInfo(String string, String string2, AccessLockerDeviceType accessLockerDeviceType, AccessLockerStorageType accessLockerStorageType) {
    }

    public static AccessLockerCancelSecurityCodeInfo fromJson(String string) {
        return null;
    }
