...
ByteStream {
    ...
    public WaylineActionAccurateShootSize(Integer width, Integer height) {
        if (width != null) {
            this.width = width;
        }
        if (height != null) {
    ...
    public static WaylineActionAccurateShootSize fromJson(String jsonString) {
        WaylineActionAccurateShootSize tmpValueResult_ = new WaylineActionAccurateShootSize();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WaylineActionAccurateShootSize)) {
            return false;
        }
        WaylineActionAccurateShootSize that = (WaylineActionAccurateShootSize)o;
