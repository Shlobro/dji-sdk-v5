...
ByteStream {
    ...
    public MasterShotRect() {
    }

    public MasterShotRect(Double d2, Double d3, Double d4, Double d5) {
    }

    public static MasterShotRect fromJson(String string) {
        return null;
    }
