...
public class DJIBleKey {
    ...
    public static final DJIKeyInfo<String> KeyBLEMacAddress = new DJIKeyInfo(componentType.value(), subComponentType.value(), "BLEMacAddress", SingleValueConverter.StringConverter).canGet(true).canSet(false).canListen(false).canPerformAction(false).setIsEvent(false);
    public static final DJIKeyInfo<String> KeyBLEPeripheralName = new DJIKeyInfo(componentType.value(), subComponentType.value(), "BLEPeripheralName", SingleValueConverter.StringConverter).canGet(true).canSet(true).canListen(false).canPerformAction(false).setIsEvent(false);
    ...
    static {
        keyList.add(KeyBLEMacAddress);
        keyList.add(KeyBLEPeripheralName);
