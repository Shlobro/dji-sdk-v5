...
public class ActionTakePhotoParam
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    ...
    public ActionTakePhotoParam() {
    }

    public ActionTakePhotoParam(Integer payloadPositionIndex, Boolean useGlobalPayloadLensIndex, List<CameraLensType> payloadLensIndex, String fileSuffix) {
    ...
    public static ActionTakePhotoParam fromJson(String jsonString) {
        ActionTakePhotoParam tmpValueResult_ = new ActionTakePhotoParam();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ActionTakePhotoParam)) {
            return false;
        }
        ActionTakePhotoParam that = (ActionTakePhotoParam)o;
