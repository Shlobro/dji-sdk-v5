...
public class CloudLiveResponseSetQualityOutput
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    CloudVideoStreamQuality video_quality;

    public CloudLiveResponseSetQualityOutput() {
    }

    public CloudLiveResponseSetQualityOutput(CloudVideoStreamQuality cloudVideoStreamQuality) {
    }

    public static CloudLiveResponseSetQualityOutput fromJson(String string) {
        return null;
    }
