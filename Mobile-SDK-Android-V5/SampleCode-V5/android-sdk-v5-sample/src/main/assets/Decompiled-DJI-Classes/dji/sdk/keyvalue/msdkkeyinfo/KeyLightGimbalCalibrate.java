...
public class KeyLightGimbalCalibrate
extends MSDKActionInfo<EmptyMsg, EmptyMsg> {
    @Override
    ...
    @Override
    public void performAction(EmptyMsg emptyMsg, CommonCallbacks.CompletionCallbackWithParam<EmptyMsg> completionCallbackWithParam, KeyParam keyParam) {
    }
}
