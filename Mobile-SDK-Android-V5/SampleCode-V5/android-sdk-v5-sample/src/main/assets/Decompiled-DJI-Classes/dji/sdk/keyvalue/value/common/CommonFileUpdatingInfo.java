...
public class CommonFileUpdatingInfo
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    ...
    public CommonFileUpdatingInfo() {
    }

    public CommonFileUpdatingInfo(CommonFileUpdateState commonFileUpdateState, Integer n) {
    }

    public static CommonFileUpdatingInfo fromJson(String string) {
        return null;
    }
