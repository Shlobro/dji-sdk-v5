...
import dji.sdk.wpmz.value.mission.WaylineActionCameraFocusType;
...
public class ActionSetFocusTypeParam
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    Integer payloadPositionIndex = 0;
    List<CameraLensType> payloadLensIndex = new ArrayList<CameraLensType>();
    WaylineActionCameraFocusType focusType = WaylineActionCameraFocusType.UNKNOWN;

    public ActionSetFocusTypeParam() {
    }

    public ActionSetFocusTypeParam(Integer payloadPositionIndex, List<CameraLensType> payloadLensIndex, WaylineActionCameraFocusType focusType) {
    ...
    public static ActionSetFocusTypeParam fromJson(String jsonString) {
        ActionSetFocusTypeParam tmpValueResult_ = new ActionSetFocusTypeParam();
        ...
        try {
            ...
            tmpValueResult_.focusType = WaylineActionCameraFocusType.find(jsonObj.getInt("focusType"));
        }
        catch (Exception e) {
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            if (null != this.focusType) {
                json.put("focusType", this.focusType.value());
            }
        }
        catch (Exception e) {
            e.printStackTrace();
    ...
    public int serializedLength() {
        ...
        return serializedLength += ByteStreamHelper.integerGetLength(this.focusType.value());
    }
    ...
    public int toBytes(byte[] resultBytes, int serializedIndex) {
        ...
        serializedIndex = ByteStreamHelper.integerToBytes(resultBytes, this.focusType.value(), serializedIndex);
    ...
    public int fromBytes(byte[] data, int deserilizationIndex) {
        ...
        ByteResult<Integer> tmpFocusType = ByteStreamHelper.integerFromBytes(data, deserilizationIndex);
        this.focusType = WaylineActionCameraFocusType.find((Integer)tmpFocusType.result);
        deserilizationIndex = tmpFocusType.endIndex;
    ...
    public void setFocusType(WaylineActionCameraFocusType focusType) {
        this.focusType = focusType;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ActionSetFocusTypeParam)) {
            return false;
        }
        ActionSetFocusTypeParam that = (ActionSetFocusTypeParam)o;
        return Objects.equals(this.payloadPositionIndex, that.payloadPositionIndex) && Objects.equals(this.payloadLensIndex, that.payloadLensIndex) && Objects.equals(this.focusType, that.focusType);
    }

    public int hashCode() {
        return Objects.hash(this.payloadPositionIndex, this.payloadLensIndex, this.focusType);
    }
}
