...
public class AirLinkFirmwareSupportInfo
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    ...
    public AirLinkFirmwareSupportInfo() {
    }

    public AirLinkFirmwareSupportInfo(Boolean bl, Boolean bl2) {
    }

    public static AirLinkFirmwareSupportInfo fromJson(String string) {
        return null;
    }
