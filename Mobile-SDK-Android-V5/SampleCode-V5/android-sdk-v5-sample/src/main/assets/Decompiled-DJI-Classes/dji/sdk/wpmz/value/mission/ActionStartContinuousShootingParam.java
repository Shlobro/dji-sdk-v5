...
public class ActionStartContinuousShootingParam
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    ...
    public ActionStartContinuousShootingParam() {
    }

    public ActionStartContinuousShootingParam(Integer payloadPositionIndex, Boolean useGlobalPayloadLensIndex, List<CameraLensType> payloadLensIndex, String fileSuffix) {
    ...
    public static ActionStartContinuousShootingParam fromJson(String jsonString) {
        ActionStartContinuousShootingParam tmpValueResult_ = new ActionStartContinuousShootingParam();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ActionStartContinuousShootingParam)) {
            return false;
        }
        ActionStartContinuousShootingParam that = (ActionStartContinuousShootingParam)o;
