...
public class QuickShotModeRange
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    List<QuickShotMode> value;

    public QuickShotModeRange() {
    }

    public QuickShotModeRange(List<QuickShotMode> list) {
    }

    public static QuickShotModeRange fromJson(String string) {
        return null;
    }
