...
public class WaylineActionOrientedPhotoDeviceInformation
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    ...
    public WaylineActionOrientedPhotoDeviceInformation() {
    }

    public WaylineActionOrientedPhotoDeviceInformation(Integer camera_type, Integer payloadPositionIndex, Integer gimbal_port) {
        if (camera_type != null) {
    ...
    public static WaylineActionOrientedPhotoDeviceInformation fromJson(String jsonString) {
        WaylineActionOrientedPhotoDeviceInformation tmpValueResult_ = new WaylineActionOrientedPhotoDeviceInformation();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WaylineActionOrientedPhotoDeviceInformation)) {
            return false;
        }
        WaylineActionOrientedPhotoDeviceInformation that = (WaylineActionOrientedPhotoDeviceInformation)o;
