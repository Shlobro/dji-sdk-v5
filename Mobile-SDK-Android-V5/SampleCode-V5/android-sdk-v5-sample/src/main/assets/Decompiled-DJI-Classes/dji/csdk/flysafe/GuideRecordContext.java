...
public final class GuideRecordContext
extends Message<GuideRecordContext, Builder> {
    public static final ProtoAdapter<GuideRecordContext> ADAPTER = new ProtoAdapter_GuideRecordContext();
    ...
    public GuideRecordContext(Integer n, Integer n2, Integer n3, String string, String string2) {
    }

    public GuideRecordContext(Integer n, Integer n2, Integer n3, String string, String string2, ByteString byteString) {
    }
    ...
    extends Message.Builder<GuideRecordContext, Builder> {
        ...
        public GuideRecordContext build() {
            return null;
        }
    }

    private static final class ProtoAdapter_GuideRecordContext
    extends ProtoAdapter<GuideRecordContext> {
        ProtoAdapter_GuideRecordContext() {
        }

        public int encodedSize(GuideRecordContext guideRecordContext) {
            return 0;
        }

        public void encode(ProtoWriter protoWriter, GuideRecordContext guideRecordContext) throws IOException {
        }

        public GuideRecordContext decode(ProtoReader protoReader) throws IOException {
            return null;
        }

        public GuideRecordContext redact(GuideRecordContext guideRecordContext) {
            return null;
        }
    }
}
