...
public class ActionSprayCloseParam
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    Integer payloadPositionIndex = 0;

    public ActionSprayCloseParam() {
    }

    public ActionSprayCloseParam(Integer payloadPositionIndex) {
        if (payloadPositionIndex != null) {
            this.payloadPositionIndex = payloadPositionIndex;
        }
    }

    public static ActionSprayCloseParam fromJson(String jsonString) {
        ActionSprayCloseParam tmpValueResult_ = new ActionSprayCloseParam();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ActionSprayCloseParam)) {
            return false;
        }
        ActionSprayCloseParam that = (ActionSprayCloseParam)o;
