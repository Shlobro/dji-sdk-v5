...
public class OpticalZoomRatioParam
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    ZoomType zoomType;
    ...
    public OpticalZoomRatioParam(ZoomType zoomType, ZoomSpeed zoomSpeed, Integer n) {
    }

    public static OpticalZoomRatioParam fromJson(String string) {
        return null;
    }
