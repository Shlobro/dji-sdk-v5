...
public class DJIBatteryBoxBigBatteryKey {
    protected static final List<DJIKeyInfo<?>> keyList = new ArrayList();
    private static final ComponentType componentType = ComponentType.BATTERYBOX;
    private static final SubComponentType subComponentType = SubComponentType.BATTERYBOXBIGBATTERY;
    ...
    public static final DJIKeyInfo<IndustryBatteryType> KeyBoxBatteryType = new DJIKeyInfo<IndustryBatteryType>(componentType.value(), subComponentType.value(), "BoxBatteryType", new SingleValueConverter<IndustryBatteryType, IndustryBatteryTypeMsg>(IndustryBatteryType.class, IndustryBatteryTypeMsg.class)).canGet(true).canSet(false).canListen(true).canPerformAction(false).setIsEvent(false);
