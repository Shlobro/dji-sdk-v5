...
public class FlyToMissionManager
implements IFlyToMissionManager {
    IFlyToMissionManager delegate;
    private ProductUtil.MachineType currentMachineType;
    private final List<IMissionCapabilityListener<FlyToCapability>> capabilityListeners;
    private final List<IMissionInfoListener<FlyToInfo, FlyToTarget>> missionInfoListeners;
    private final IMissionCapabilityListener<FlyToCapability> capabilityListener;
    private final IMissionInfoListener<FlyToInfo, FlyToTarget> missionInfoListener;
    ...
    private /* synthetic */ void lambda$new$0(FlyToCapability flyToCapability) {
    }

    static /* synthetic */ List access$000(FlyToMissionManager flyToMissionManager) {
        return null;
    }
}
