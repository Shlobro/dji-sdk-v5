...
public class ActionStopSmartObliqueParam
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    Integer payloadPositionIndex = 0;

    public ActionStopSmartObliqueParam() {
    }

    public ActionStopSmartObliqueParam(Integer payloadPositionIndex) {
        if (payloadPositionIndex != null) {
            this.payloadPositionIndex = payloadPositionIndex;
        }
    }

    public static ActionStopSmartObliqueParam fromJson(String jsonString) {
        ActionStopSmartObliqueParam tmpValueResult_ = new ActionStopSmartObliqueParam();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ActionStopSmartObliqueParam)) {
            return false;
        }
        ActionStopSmartObliqueParam that = (ActionStopSmartObliqueParam)o;
