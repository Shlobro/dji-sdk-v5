...
public class ActionStopTimeLapseParam
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    ...
    public ActionStopTimeLapseParam() {
    }

    public ActionStopTimeLapseParam(Integer payloadPositionIndex, List<CameraLensType> payloadLensIndex) {
    ...
    public static ActionStopTimeLapseParam fromJson(String jsonString) {
        ActionStopTimeLapseParam tmpValueResult_ = new ActionStopTimeLapseParam();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ActionStopTimeLapseParam)) {
            return false;
        }
        ActionStopTimeLapseParam that = (ActionStopTimeLapseParam)o;
        return Objects.equals(this.payloadPositionIndex, that.payloadPositionIndex) && Objects.equals(this.payloadLensIndex, that.payloadLensIndex);
    }

    public int hashCode() {
        return Objects.hash(this.payloadPositionIndex, this.payloadLensIndex);
    }
}
