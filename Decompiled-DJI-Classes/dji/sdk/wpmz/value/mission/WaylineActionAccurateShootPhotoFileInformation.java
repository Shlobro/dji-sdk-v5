...
ByteStream {
    ...
    public WaylineActionAccurateShootPhotoFileInformation(Integer file_size, String file_path, String file_md5, String fileSuffix) {
        if (file_size != null) {
    ...
    public static WaylineActionAccurateShootPhotoFileInformation fromJson(String jsonString) {
        WaylineActionAccurateShootPhotoFileInformation tmpValueResult_ = new WaylineActionAccurateShootPhotoFileInformation();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WaylineActionAccurateShootPhotoFileInformation)) {
            return false;
        }
        WaylineActionAccurateShootPhotoFileInformation that = (WaylineActionAccurateShootPhotoFileInformation)o;
