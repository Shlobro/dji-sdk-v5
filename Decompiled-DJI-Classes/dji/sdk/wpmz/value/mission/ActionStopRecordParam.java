...
public class ActionStopRecordParam
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    ...
    public ActionStopRecordParam() {
    }

    public ActionStopRecordParam(Integer payloadPositionIndex, List<CameraLensType> payloadLensIndex) {
    ...
    public static ActionStopRecordParam fromJson(String jsonString) {
        ActionStopRecordParam tmpValueResult_ = new ActionStopRecordParam();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ActionStopRecordParam)) {
            return false;
        }
        ActionStopRecordParam that = (ActionStopRecordParam)o;
