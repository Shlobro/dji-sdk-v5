...
public class WaylineActionOrientedShootPoint
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    Integer x = 0;
    ...
    public WaylineActionOrientedShootPoint() {
    }

    public WaylineActionOrientedShootPoint(Integer x, Integer y) {
        if (x != null) {
            this.x = x;
        }
        if (y != null) {
    ...
    public static WaylineActionOrientedShootPoint fromJson(String jsonString) {
        WaylineActionOrientedShootPoint tmpValueResult_ = new WaylineActionOrientedShootPoint();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WaylineActionOrientedShootPoint)) {
            return false;
        }
        WaylineActionOrientedShootPoint that = (WaylineActionOrientedShootPoint)o;
