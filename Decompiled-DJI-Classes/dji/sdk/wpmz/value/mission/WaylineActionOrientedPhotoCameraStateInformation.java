...
public class WaylineActionOrientedPhotoCameraStateInformation
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    ...
    public WaylineActionOrientedPhotoCameraStateInformation() {
    }

    public WaylineActionOrientedPhotoCameraStateInformation(Double focal_distance, Integer AF_position, Integer cameraApertue, Integer cameraLuminance, Integer cameraObjectDistance, Double cameraShutterTime, Integer cameraISO, Integer cameraEvBias) {
    ...
    public static WaylineActionOrientedPhotoCameraStateInformation fromJson(String jsonString) {
        WaylineActionOrientedPhotoCameraStateInformation tmpValueResult_ = new WaylineActionOrientedPhotoCameraStateInformation();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WaylineActionOrientedPhotoCameraStateInformation)) {
            return false;
        }
        WaylineActionOrientedPhotoCameraStateInformation that = (WaylineActionOrientedPhotoCameraStateInformation)o;
