...
public class DJIBeaconKey {
    ...
    private static final SubComponentType subComponentType = SubComponentType.BEACON;
    public static final DJIKeyInfo<Boolean> KeyIsBeaconOpened = new DJIKeyInfo(componentType.value(), subComponentType.value(), "IsBeaconOpened", SingleValueConverter.BooleanConverter).canGet(true).canSet(true).canListen(true).canPerformAction(false).setIsEvent(false);
    public static final DJIKeyInfo<Integer> KeyFlashingFrequency = new DJIKeyInfo(componentType.value(), subComponentType.value(), "FlashingFrequency", SingleValueConverter.IntegerConverter).canGet(true).canSet(true).canListen(true).canPerformAction(false).setIsEvent(false);
    ...
    static {
        keyList.add(KeyIsBeaconOpened);
        keyList.add(KeyFlashingFrequency);
