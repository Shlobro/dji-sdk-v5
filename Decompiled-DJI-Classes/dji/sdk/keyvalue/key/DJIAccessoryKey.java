...
public class DJIAccessoryKey {
    ...
    public static final DJIKeyInfo<Boolean> KeyIsSupported = new DJIKeyInfo(componentType.value(), subComponentType.value(), "IsSupported", SingleValueConverter.BooleanConverter).canGet(true).canSet(false).canListen(true).canPerformAction(false).setIsEvent(false);
