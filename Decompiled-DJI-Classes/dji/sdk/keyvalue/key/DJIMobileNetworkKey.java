...
import dji.sdk.keyvalue.value.mobilenetwork.MobileNetworkState;
import java.util.ArrayList;
import java.util.List;

public class DJIMobileNetworkKey {
    ...
    public static final DJIKeyInfo<MobileNetworkState> KeyAircraftNetworkState = new DJIKeyInfo(componentType.value(), subComponentType.value(), "AircraftNetworkState", new DJIValueConverter<MobileNetworkState>(MobileNetworkState.class)).canGet(true).canSet(false).canListen(true).canPerformAction(false).setIsEvent(false);
    public static final DJIKeyInfo<MobileNetworkState> KeyRemoteControllerNetworkState = new DJIKeyInfo(componentType.value(), subComponentType.value(), "RemoteControllerNetworkState", new DJIValueConverter<MobileNetworkState>(MobileNetworkState.class)).canGet(true).canSet(false).canListen(true).canPerformAction(false).setIsEvent(false);
    ...
    static {
        keyList.add(KeyAircraftNetworkState);
        keyList.add(KeyRemoteControllerNetworkState);
