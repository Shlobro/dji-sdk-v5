...
public class DJIGlassKey {
    protected static final List<DJIKeyInfo<?>> keyList = new ArrayList();
    private static final ComponentType componentType = ComponentType.GLASS;
    private static final SubComponentType subComponentType = SubComponentType.IGNORE;
    public static final DJIKeyInfo<DroneType> KeyDroneType = new DJIKeyInfo<DroneType>(componentType.value(), subComponentType.value(), "DroneType", new SingleValueConverter<DroneType, DroneTypeMsg>(DroneType.class, DroneTypeMsg.class)).canGet(true).canSet(false).canListen(true).canPerformAction(false).setIsEvent(false);
