...
import dji.sdk.keyvalue.value.batterybox.BatteryBoxChargerModeMsg;
import dji.sdk.keyvalue.value.batterybox.ChargerEstimatedTime;
...
public class DJIBatteryBoxKey {
    ...
    public static final DJIKeyInfo<ChargerEstimatedTime> KeyBatteryBoxChargerEstimatedTime = new DJIKeyInfo(componentType.value(), subComponentType.value(), "BatteryBoxChargerEstimatedTime", new DJIValueConverter<ChargerEstimatedTime>(ChargerEstimatedTime.class)).canGet(true).canSet(false).canListen(true).canPerformAction(false).setIsEvent(false);
    public static final DJIKeyInfo<BatteryBoxChargerMode> KeyBatteryBoxChargerMode = new DJIKeyInfo<BatteryBoxChargerMode>(componentType.value(), subComponentType.value(), "BatteryBoxChargerMode", new SingleValueConverter<BatteryBoxChargerMode, BatteryBoxChargerModeMsg>(BatteryBoxChargerMode.class, BatteryBoxChargerModeMsg.class)).canGet(true).canSet(false).canListen(true).canPerformAction(false).setIsEvent(false);
    ...
    static {
        keyList.add(KeyBatteryBoxChargerEstimatedTime);
        keyList.add(KeyBatteryBoxChargerMode);
