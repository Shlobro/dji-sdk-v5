...
import dji.sdk.keyvalue.value.mobilenetwork.LinkTypeMsg;
import dji.sdk.keyvalue.value.mobilenetwork.MobileNetworkLinkStateMsg;
import java.util.ArrayList;
import java.util.List;

public class DJIMobileNetworkLinkRCKey {
    protected static final List<DJIKeyInfo<?>> keyList = new ArrayList();
    private static final ComponentType componentType = ComponentType.MOBILENETWORK;
    private static final SubComponentType subComponentType = SubComponentType.MOBILENETWORKLINKRC;
    public static final DJIKeyInfo<MobileNetworkLinkStateMsg> KeyMobileNetworkLinkState = new DJIKeyInfo(componentType.value(), subComponentType.value(), "MobileNetworkLinkState", new DJIValueConverter<MobileNetworkLinkStateMsg>(MobileNetworkLinkStateMsg.class)).canGet(true).canSet(false).canListen(true).canPerformAction(false).setIsEvent(false);
    public static final DJIKeyInfo<Boolean> KeyAutoSwitchLinkEnabled = new DJIKeyInfo(componentType.value(), subComponentType.value(), "AutoSwitchLinkEnabled", SingleValueConverter.BooleanConverter).canGet(true).canSet(true).canListen(true).canPerformAction(false).setIsEvent(false);
    public static final DJIKeyInfo<LinkTypeMsg> KeySwitchLinkType = new DJIKeyInfo(componentType.value(), subComponentType.value(), "SwitchLinkType", new DJIValueConverter<LinkTypeMsg>(LinkTypeMsg.class)).canGet(true).canSet(true).canListen(true).canPerformAction(false).setIsEvent(false);
    ...
    static {
        keyList.add(KeyMobileNetworkLinkState);
        keyList.add(KeyAutoSwitchLinkEnabled);
        keyList.add(KeySwitchLinkType);
