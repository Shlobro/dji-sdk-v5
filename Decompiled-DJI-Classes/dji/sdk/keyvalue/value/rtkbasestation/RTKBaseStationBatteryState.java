...
public class RTKBaseStationBatteryState
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    Integer voltage;
    ...
    public RTKBaseStationBatteryState(Integer n, Integer n2, Integer n3, Integer n4) {
    }

    public static RTKBaseStationBatteryState fromJson(String string) {
        return null;
    }
