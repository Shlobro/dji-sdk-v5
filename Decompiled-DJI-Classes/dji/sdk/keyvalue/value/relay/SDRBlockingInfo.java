...
ByteStream {
    ...
    public SDRBlockingInfo() {
    }

    public SDRBlockingInfo(Integer n, RelaySdrRoleType relaySdrRoleType, Integer n2, RelaySdrRoleType relaySdrRoleType2, Boolean bl) {
    }

    public static SDRBlockingInfo fromJson(String string) {
        return null;
    }
    ...
    public void setIsBlock(Boolean bl) {
    }
