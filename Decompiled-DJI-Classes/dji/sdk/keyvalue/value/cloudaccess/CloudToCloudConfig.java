...
public class CloudToCloudConfig
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    Integer expire;
    ...
    public CloudToCloudConfig() {
    }

    public CloudToCloudConfig(Integer n, String string, String string2, String string3, String string4, String string5, String string6, String string7, String string8, String string9) {
    }

    public static CloudToCloudConfig fromJson(String string) {
        return null;
    }
    ...
    public void setTokenUUID(String string) {
    }
