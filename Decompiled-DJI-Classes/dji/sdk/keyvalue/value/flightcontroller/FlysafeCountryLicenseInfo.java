...
public class FlysafeCountryLicenseInfo
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    ...
    public FlysafeCountryLicenseInfo(FlysafeLicenseBaseInfo flysafeLicenseBaseInfo, Integer n, Integer n2) {
    }

    public static FlysafeCountryLicenseInfo fromJson(String string) {
        return null;
    }
    ...
    public void setCountryNumber(Integer n) {
    }
