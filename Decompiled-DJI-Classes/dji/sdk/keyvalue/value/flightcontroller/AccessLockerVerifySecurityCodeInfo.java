...
public class AccessLockerVerifySecurityCodeInfo
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    String username;
    ...
    public AccessLockerVerifySecurityCodeInfo() {
    }

    public AccessLockerVerifySecurityCodeInfo(String string, String string2, AccessLockerDeviceType accessLockerDeviceType, AccessLockerStorageType accessLockerStorageType) {
    }

    public static AccessLockerVerifySecurityCodeInfo fromJson(String string) {
        return null;
    }
