...
public class SpotlightZoomExitReasonMsg
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    SpotlightZoomStatusTipAndExitReason value;

    public SpotlightZoomExitReasonMsg() {
    }

    public SpotlightZoomExitReasonMsg(SpotlightZoomStatusTipAndExitReason spotlightZoomStatusTipAndExitReason) {
    }

    public static SpotlightZoomExitReasonMsg fromJson(String string) {
        return null;
    }
