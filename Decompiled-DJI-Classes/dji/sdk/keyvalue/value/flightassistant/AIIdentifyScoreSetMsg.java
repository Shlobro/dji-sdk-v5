...
public class AIIdentifyScoreSetMsg
implements DJIValue,
JNIProguardKeepTag,
ByteStream {
    Integer model_index;
    ...
    public AIIdentifyScoreSetMsg() {
    }

    public AIIdentifyScoreSetMsg(Integer n, AIIdentifyMode aIIdentifyMode, Integer n2) {
    }

    public static AIIdentifyScoreSetMsg fromJson(String string) {
        return null;
    }
